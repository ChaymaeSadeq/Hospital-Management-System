...
public class Admin extends JFrame {
	...
	public 	Admin() {
	    ...
	    llp3.setForeground(new Color(53, 153, 134));
		...
		p1.setBackground(new Color(28, 137, 117));
		...
		ll=new JLabel();
		ll.setOpaque(true);
		ll.setBackground(new Color(28, 137, 117));
		lll=new JLabel();
				...
				class Action3 implements ActionListener{
					...
					b1.addMouseListener(new java.awt.event.MouseAdapter() {
					    public void mouseEntered(java.awt.event.MouseEvent evt) {
					        b1.setBackground(new Color(28, 204, 171));
					    }
					...
					b2.addMouseListener(new java.awt.event.MouseAdapter() {
					    public void mouseEntered(java.awt.event.MouseEvent evt) {
					        b2.setBackground(new Color(28, 204, 171));
					    }
					...
					b3.addMouseListener(new java.awt.event.MouseAdapter() {
					    public void mouseEntered(java.awt.event.MouseEvent evt) {
					        b3.setBackground(new Color(28, 204, 171));
					    }
